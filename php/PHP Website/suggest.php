                ...
                <table>
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>  <input type="text" id="email" name="email" placeholder="youremail@email.com"
                     ...
                     <tr>
                        ...
                        <td><input type="text" id="title" name="title"
                                 value="<?php if(isset($title)) echo $title; ?>"></td>
                    </tr>
                                 <tr>
                <th>
                ...
                <td>
                    ...
                    <tr>
                        ...
                        <td>  <input type="text" id="year" name="year"
                                   value="<?php if(isset($year)) echo $year; ?>"></td>
                    </tr>
                     <tr>
                        <th><label for="details">Additional Details</label></th>
                        <td><textarea id="details" name="details">
                            <?php if(isset($details)) echo htmlspecialchars($_POST['details']); ?></textarea></td>
                    </tr>
